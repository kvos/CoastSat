...
polygon = SDS_tools.coords_from_kml('polygon.kml')
...
# if on the East coast of Australia, get a shoreline from the database
settings['refsl'] = SDS_preprocess.get_reference_sl_from_db(polygon, settings)
